        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedInAccessToken = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    LinkedInRefreshToken = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobMarketSkills", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobMarketSkills_Careers_CareerId",
                        column: x => x.CareerId,
                        principalTable: "Careers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobMarketSkills_Skills_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobMarketSkills_CareerId",
                table: "JobMarketSkills",
                column: "CareerId");

            migrationBuilder.CreateIndex(
                name: "IX_JobMarketSkills_SkillId",
                table: "JobMarketSkills",
                column: "SkillId");
